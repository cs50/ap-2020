...
- Due First day back after TET holiday; 1. Read all the notes and reference sheets in the [Impact of Computing chapter](https://suzede.github.io/ap/curriculum/impact_of_computing/) 2. Read the [Degrees of scalability](https://docs.cs50.net/2019/ap/problems/scalability/scalability.html) information, watch the videos and answer the questions in [this form](https://forms.gle/9HVjQrbrfLqKWVJG6) 3. [Written problem: Simulate](https://docs.google.com/document/d/1aDvpwfB3EnDHDY3VLMEJUmPGbRgfCdQgyZ75iCKPL0I/edit).

- Due Thurs 16/Jan Complete [situation part 3 & 4 in your data science project](https://drive.google.com/drive/folders/1hYvjLIwt1pZ7MYYFJZCYkoLFs__XYF6G) Look out for emails from others in the CSP classes and be sure to look at their data and answer their quiz questions before Thursday (we are all aiming for at least 10 survey responses).

- Due Tues 14/Jan Complete the processing of your team's data (clean, sort, filter, and transform the data in your google sheet as necessary to make it in a usable format for analysis) and create a visualization of the data in google sheets. Use the [situations part 1&2 instructions and resources to help you](https://drive.google.com/file/d/1XhZJnlHUh8fKDR3PBIv_Ondetm3Mcw3-/view?usp=sharing)

- Due Fri 10/Jan Over the Christmas break, read through the [Data Science Chapter on CS50](https://suzede.github.io/ap/curriculum/data_science/) and practice the [practice quiz questions in Albert](https://www.albert.io/assignment/54f9c1f3-f8a4-4b89-a79a-739c561bb9c2). This will help you prepare for our data science project in January. Have a good break!
